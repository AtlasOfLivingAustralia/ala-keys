...
<div id="list-project" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="created" title="${message(code: 'project.created.label', default: 'Created')}"/>
        ...
        <g:each in="${projectInstanceList}" status="i" var="projectInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${projectInstance.id}">${fieldValue(bean: projectInstance, field: "created")}</g:link></td>
